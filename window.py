...
from function import is_chess_exists, switch_type
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.chess_type = "x"
        self.chess_list = []
        self.board = [["none"] * NUMBER_ROW] * NUMBER_COLUMN
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if not(is_chess_exists(chess_temp, self.chess_list)):
            ...
            self.board[chess_temp.index_x][chess_temp.index_y] = self.chess_type
